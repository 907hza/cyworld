...
<script>
	$(document).ready(function(){
		  ...
		  $("#btnList").on("click",function(){
			 if(confirm("글 작성을 취소ㅎrㅅiㄴr요?")==true)
			{
          ...
          <div class="content-container">
            ...
            <div class="box content-box" >
              ...
              <div class="news-flex-box">
                <div class="news-box">
                <div class="box-title">글 쓰ㄱi</div>
                  <div class="news-row">
		<div class="container">
		<br>
		<form name="writeForm" id="writeForm" action="/board/writeProc7.jsp" post="method">
        <input type="text" id="bTitle" name="bTitle" placeholder="제목">
        &nbsp;&nbsp;&nbsp; [ 글쓴Oi : <%=user7.getuNickname() %> ]
        <br><br>
        <textarea name="bContent" id="bContent" placeholder="ㄴH용"></textarea>
        <br><br>
